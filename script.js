...
const STORAGE_KEY = 'talaride_poster_draft_v3';

// Clear legacy drafts so latest TalaRide template displays immediately
try {
  localStorage.removeItem('talaride_poster_draft_v2');
